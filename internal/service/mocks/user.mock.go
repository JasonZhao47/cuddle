...
func (m *MockUserService) UpdateNonPII(ctx context.Context, user domain.User) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateNonPII", ctx, user)
	ret0, _ := ret[0].(error)
	return ret0
}
...
func (mr *MockUserServiceMockRecorder) UpdateNonPII(ctx, user any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateNonPII", reflect.TypeOf((*MockUserService)(nil).UpdateNonPII), ctx, user)
}
